...
export type PostsQuery = { __typename?: 'Query', allPosts?: Maybe<Array<Maybe<{ __typename?: 'Post', id: string, title: string, views: number, userId: number }>>> };

export type UsersQueryVariables = Exact<{ [key: string]: never; }>;


export type UsersQuery = { __typename?: 'Query', allUsers?: Maybe<Array<Maybe<{ __typename?: 'User', id: string, name: string }>>> };
